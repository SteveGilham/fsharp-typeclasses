...
type Cont<'R,'A> with
    static member instance (_Applicative:Pure, _:Cont<'r,'a>) = fun (x:'a) -> Applicative.pure' x :Cont<'r,_>
    static member instance (_Applicative:Ap, f:Cont<'r,_>, x:Cont<'r,'a>, _:Cont<'r,'b>) = fun () -> Applicative.ap f x :Cont<'r,'b>
