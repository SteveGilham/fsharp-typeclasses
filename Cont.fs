...
type Cont<'R,'A> with
    ...
    static member instance (Applicative.Pure, _:Cont<'r,'a>) = fun (x:'a) -> DefaultImpl.Pure x :Cont<'r,_>
    static member instance (Applicative.Ap, f:Cont<'r,_>, x:Cont<'r,'a>, _:Cont<'r,'b>) = fun () -> DefaultImpl.Ap f x :Cont<'r,'b>