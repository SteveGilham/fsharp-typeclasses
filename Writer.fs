...
type Writer<'W,'A> with
    static member inline instance (_Applicative:Pure, _:Writer<'w,'a>) = fun (x:'a) -> Applicative.pure' x :Writer<'w,_>
    static member inline instance (_Applicative:Ap, f:Writer<'w,_>, x:Writer<'w,'a>, _:Writer<'w,'b>) = fun () -> Applicative.ap f x :Writer<'w,'b>
