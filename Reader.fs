...
type Reader<'R,'A> with
    static member instance (_Applicative:Pure, _:Reader<'r,'a>) = fun (x:'a) -> Applicative.pure' x :Reader<'r,_>
    static member instance (_Applicative:Ap, f:Reader<'r,_>, x:Reader<'r,'a>, _:Reader<'r,'b>) = fun () -> Applicative.ap f x :Reader<'r,'b>
